...
```{r}
data_merlan = read.csv2(file = "Données Merlan.csv", sep = ",")
```
...
FONCTIONNE MAIS DEMANDER INTERPRETATION
**Manque variable Bathymetry**
